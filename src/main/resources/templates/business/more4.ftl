...
<head>
	...
	<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            layui.use(['layer','form','layedit','laydate','upload'], function(){
                ...
                upload.render({
				    ...
				    url: '${request.contextPath!}/admin/more4/import',
		...
		function downLoadLog(id){
			window.open('${request.contextPath!}/admin/more4/downLoadLog?id=' + id);
		}
        ...
        function pageInit() {
            ...
            jQuery("#list2").jqGrid({
                ...
                url: '${request.contextPath!}/admin/more4/list',
            ...
            $("#downModule").click(function () {
                window.open('${request.contextPath!}/admin/more4/importModule.xls');
            });
        };
    </script>
</head>
