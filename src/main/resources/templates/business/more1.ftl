...
<head>
	...
	<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            layui.use(['layer','form','layedit','laydate','upload'], function(){
                ...
                upload.render({
				    ...
				    url: '${request.contextPath!}/admin/more1/import',
		...
		function downLoadLog(id){
			window.open('${request.contextPath!}/admin/more1/downLoadLog?id=' + id);
		}
        function pageInit() {
            $("#importAction").hide();
            checkOperate('${request.contextPath!}',6201,false);
            //创建jqGrid组件
            jQuery("#list2").jqGrid({
                mtype: "post",//向后台请求数据的ajax的类型。可选post,get
                url: '${request.contextPath!}/admin/more1/list',
            ...
            $("#downModule").click(function () {
                window.open('${request.contextPath!}/admin/more1/importModule.xls');
            });
        };
    </script>
</head>
