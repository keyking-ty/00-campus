...
<head>
	...
	<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            layui.use(['layer','form','layedit','laydate','upload'], function(){
                ...
                upload.render({
				    ...
				    url: '${request.contextPath!}/admin/more5/import',
		...
		function downLoadLog(id){
			window.open('${request.contextPath!}/admin/more5/downLoadLog?id=' + id);
		}
        ...
        function pageInit() {
            ...
            jQuery("#list2").jqGrid({
                ...
                url: '${request.contextPath!}/admin/more5/list',
            ...
            $("#downModule").click(function () {
                window.open('${request.contextPath!}/admin/more5/importModule.xls');
            });
        };
    </script>
</head>
