...
<body class="main_body">
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-header header">
			<div class="layui-main mag0">
				<!--a href="${request.contextPath!}/welcome" class="logo">ZJT.Blog</a-->
				<!-- 显示/隐藏菜单 -->
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" id="userInfo">
						<a href="javascript:;">
							<#if currentUser.iconType == 0>
								<img src="${request.contextPath!}/static/images/${currentUser.iconName}" class="layui-nav-img userAvatar" width="35" height="35" />
							</#if>
							<#if currentUser.iconType == 1>
								<img src="${request.contextPath!}/file/downLoad/${currentUser.iconPicUrl}" class="layui-nav-img userAvatar" width="35" height="35" />
							</#if>
							<div id="userInfoId"></div>
						</a>
						<dl class="layui-nav-child">
							<dd pc><a href="javascript:;" class="changeSkin"><i class="layui-icon">&#xe61b;</i><cite>更换皮肤</cite></a></dd>
							<dd><a href="${request.contextPath!}/user/logout" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				...
				<#if currentUser.iconType == 0>
					<img src="${request.contextPath!}/static/images/${currentUser.iconName}" class="userAvatar"></a>
				</#if>
				<#if currentUser.iconType == 1>
					<img src="${request.contextPath!}/file/downLoad/${currentUser.iconPicUrl}" class="userAvatar"></a>
				</#if>
			...
			<div class="navBar layui-side-scroll" id="navBar">
				<ul class="layui-nav layui-nav-tree">
					<li class="layui-nav-item layui-this">
						<a href="javascript:;" data-url="${request.contextPath!}/static/page/main.html"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="layui-footer footer">
			<p><span>copyright @2018 天立泰信息有限公司</span></p>
		</div>
	</div>
	<!-- 移动导航 -->
	...
	<script type="text/javascript" >
	    ...
	    layui.config({
	        base : "${request.contextPath!}/static/js/"
	    }).extend({
	        "bodyTab" : "bodyTab"
	    })
	    layui.use(['bodyTab','form','element','layer','jquery'],function(){
	        ...
	        tab = layui.bodyTab({
	            ...
	            url : "${request.contextPath!}/user/loadMenuInfo?parentId=1",
	            method: "post"
	        });
	        ...
	        function lockPage(){
	            layer.open({
	                ...
	                '<div class="admin-header-lock-img"><img src="${request.contextPath!}/${currentUser.iconPicUrl!}" class="userAvatar"/></div>'+
	    ...
	    //图片管理弹窗
	    function showImg(){
	        $.getJSON('${request.contextPath!}/static/json/images.json', function(json){
	            var res = json;
	            layer.photos({
	                photos: res,
	                anim: 5
